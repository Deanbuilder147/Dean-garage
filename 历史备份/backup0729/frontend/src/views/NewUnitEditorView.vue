      ...
      <div v-else class="editor-form">
        ...
        <section class="form-section">
          ...
          <div class="form-row">
            ...
            <div class="size-row">
              <select id="unit-size-field" name="size" v-model="form.size" class="faction-select w-48">
...
.size-rules {
  ...
  background: rgba(19,255,67,0.06); border-left: 2px solid rgba(19,255,67,0.4);
  padding: 6px 10px; border-radius: 4px;
}
.size-rules strong { color: #13ff43; font-family: 'Fira Code', monospace; }
