#!/usr/bin/env python3
"""
Phase 7: GlossaryView.vue 结构化 CRUD 全量重写
"""
...
print(f"✅ GlossaryView.vue 全量重写完成 ({line_count} 行)")
print("  • 添加新词条按钮 + 删除词条按钮 (原子 CRUD)")
print("  • 5 个通用结构字段: target_filter / cast_range / aoe_radius / base_damage / status_effects")
print("  • 高级参数折叠面板 (类型专属字段)")
print("  • pendingDeletes 机制 (保存时提交 _delete_skills 指令)")
print("  • KEY 重命名支持 + 词条数量统计")
